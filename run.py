...
def scrape():
    usr = '0___dong'#input('[Required] - Whose followers do you want to scrape: ')

    user_input = int(60)#input('[Required] - How many followers do you want to scrape (60-500 recommended): '))
    ...
    WebDriverWait(bot, TIMEOUT).until(
        EC.presence_of_element_located((
            By.XPATH, '//*[@id="mount_0_0_a6"]/div/div[1]/div/div[1]/div/div/div/div[1]/div[1]/section/main/div/header/section/ul/li[2]/a/div'))).click()
    ...
    print('for loop')
    elem = bot.find_element_by_css_selector('#_aano')
    wheel_element(elem, -120)
